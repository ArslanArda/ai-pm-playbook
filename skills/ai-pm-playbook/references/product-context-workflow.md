...
2. Map the new information into the correct template sections.
3. Preserve useful existing content unless the user is clearly replacing it.
4. Rewrite fragmented notes into durable structured prose.
5. If the file does not exist yet, create it from the template using the user’s supplied information.
6. Ask a follow-up question only when the update is too ambiguous to place safely.
