...
If you change content in the main playbook folders, keep the bundled distribution copy under `skills/ai-pm-playbook/references/` in sync. The wrapper skill file should stay concise; the heavier reference material belongs under `references/`.
